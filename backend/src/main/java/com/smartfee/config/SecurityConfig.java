    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        // 2. Chỉ ADMIN, ACCOUNTANT hoặc RESIDENT mới được gạch nợ/thanh toán hóa đơn
                        .requestMatchers(HttpMethod.POST, "/api/invoices/*/mark-paid").hasAnyRole("ADMIN", "ACCOUNTANT", "RESIDENT")
